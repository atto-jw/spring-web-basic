...
public class BookRepository {
    ...
    // 웹 에플리케이션은 동시에 여러 요청이 한꺼번에 들어올 수 있기 때문에
    // 멀티 스레드에서도 안전하게 사용 할 수 있는 HashMap을 사용, HashMap 기능 동일
    ...
    // 도서 단일 조회
    // id에 따라서 조회가 안 될 수도 있음 -> 조회가 안되면 null 리턴 -> NPE 발생 가능성이 높아짐
    // Optional로 포장해서 호출한 쪽에서 충분한 검증 후에 Book 객체 사용하도록 유도
